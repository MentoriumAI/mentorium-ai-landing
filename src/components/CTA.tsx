      ...
      <div className="container">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <h2 className="text-fluid-3xl sm:text-fluid-4xl font-bold text-brand-dark-green mb-6 leading-tight mt-6 sm:mt-8">
            <span className="bg-gradient-to-r from-brand-p3-brandeis-blue to-brand-p3-brunswick-green bg-clip-text text-transparent">Transforma tu institución hoy</span>
          </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8 mb-12 sm:mb-16">
            <div className="card">
              <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-xl bg-p3-green flex items-center justify-center mx-auto mb-4">
            ...
            <div className="card">
              <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-xl bg-p3-blue flex items-center justify-center mx-auto mb-4">
                <svg className="w-5 h-5 sm:w-6 sm:h-6 text-white" fill="currentColor" viewBox="0 0 20 20">
            ...
            <div className="card">
              <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-xl bg-brand-p3-sunglow flex items-center justify-center mx-auto mb-4">
                <svg className="w-5 h-5 sm:w-6 sm:h-6 text-white" fill="currentColor" viewBox="0 0 20 20">
